...
ventas_productos["ES"] = ExponentialSmoothing(ventas_productos["Cantidad"], trend="add", seasonal="add", seasonal_periods=7).fit(
...
plt.plot(ventas_productos["ES"], color="red", label="Predicción Triple Exponential Smoothing")
