...
@ray.remote
def politica_T_s_S_optuna_sensibilidad(demandas: dict, lista_fechas: list, fecha_min, nombre_prod, params_producto, lista_leadtimes):
    study = optuna.create_study(direction="maximize")
    ...
    for loop_leadtime in lista_leadtimes:
        ganancias, *others, ventas, ordenes_realizadas, quiebres_stock, demanda_perdida, cantidad_comprada, inv, costo_almacena_prod, costo_fijo_clp, costo_compra_clp = politica_T_s_S(diccionario_demandas=demandas,
                                                                                 ...
                                                                                 s=best_params["s"],
                                                                                 S=best_params["S"])
        valores[contador] = (ganancias, nombre_prod, ventas, ordenes_realizadas, quiebres_stock, demanda_perdida, cantidad_comprada, inv, costo_almacena_prod, costo_fijo_clp, costo_compra_clp)
        contador += 1
