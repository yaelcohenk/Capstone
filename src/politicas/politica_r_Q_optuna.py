...
from .politica_r_Q_eval import politica_T_r_Q


@ray.remote
def politica_T_r_Q_optuna(demandas: dict, lista_fechas: list, fecha_min, nombre_prod, params_producto):
...
@ray.remote
def politica_T_r_Q_optuna_sensibilidad(demandas: dict, lista_fechas: list, fecha_min, nombre_prod, params_producto, lista_leadtimes):
    study = optuna.create_study(direction="maximize")
    ...
    for loop_leadtime in lista_leadtimes:
        ...
        valores[contador] = (ganancias, nombre_prod, ventas, ordenes_realizadas, quiebres_stock, demanda_perdida, cantidad_comprada, inv, costo_almacenaje_prod, costo_fijo_clp, costo_compra_clp)
        contador +=1
