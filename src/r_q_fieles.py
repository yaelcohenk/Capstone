...
from politicas.r_q_fieles_optuna import politica_T_r_Q_optuna
...
if __name__ == '__main__':
    ...
    for producto in productos:
        ...
        lista_ejecucion_paralelo.append(politica_T_r_Q_optuna.remote(demandas, lista_fechas, fecha_min, producto, parametros, es_fiel))
