...
@ray.remote
def politica_t_s_S_optuna(demandas: dict, lista_fechas: list, fecha_min, nombre_prod, params_producto, es_fiel):
    ...
    def optimizar_t_s_S_optuna(trial,
        ...
        for fecha in lista_fechas:
            ...
            if contador_dias_pasados % T == 0:
                if inventario < s and orden_en_camino is False:
    ...
    ganancias, *others, ventas, ordenes_realizadas, quiebres_stock, demanda_perdida, cantidad_comprada, inv, costo_almacenaje_prod, costo_fijo_clp, costo_compra_clp, quiebres_stock_fiels = politica_T_s_S(diccionario_demandas=demandas,
                                                                             lista_fechas=lista_fechas,
                                                                             fecha_min=fecha_min,
                                                                             nombre_prod="",
                                                                             leadtime=leadtime,
